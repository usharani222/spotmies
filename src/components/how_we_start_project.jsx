    ...
    <div className="w-[100vw h-fit md:h-[50vh] bg-bg1 py-[5vh]">
      <div className="m-auto w-[90%] h-full flex flex-col">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
          {blockComp(
            <AiOutlineFileSearch className="text-7xl text-text_color1 ml-[-8px] opacity-80" />,
            "Analyze",
            " We analyze your requirements and provide you with the best solution"
          )}

          {blockComp(
            <AiOutlineBuild className="text-7xl text-text_color1 ml-[-8px] opacity-80" />,
            "Design",
            "The product design is done by our team of experts to give you the best experience"
          )}

          {blockComp(
            <AiOutlineAppstoreAdd className="text-7xl text-text_color1 ml-[-8px] opacity-80" />,
            "Deliver",
